...
Status: v1.2.0 published. PyPI, GHCR and the GitHub repository are live.
...
`pypi.org/project/immich-moments`, and `ghcr.io/booyaka101/immich-moments` on the v1.2.0 tag.
...
- Version 1.2.0 everywhere: `pyproject.toml`, `CHANGELOG.md`, the compose example, the README's
