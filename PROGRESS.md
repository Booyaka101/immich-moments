...
Status: v1.1.1 published. PyPI, GHCR and the GitHub repository are live.
...
`pypi.org/project/immich-moments`, and `ghcr.io/booyaka101/immich-moments` on the v1.1.1 tag.
...
- Version 1.1.1 everywhere: `pyproject.toml`, `CHANGELOG.md`, the compose example, the README's
